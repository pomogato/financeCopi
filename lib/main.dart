  ...
  Widget  format(TodoItem item) {
    ...
    return Dismissible(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(' ${item.DateLastDay}/${item
                                      .DateLastMonth}/${item.DateLastYear}',
                                    style: TextStyle(fontSize: 14),),
                                ],
                              ),
      ...
      background: Container(
        ...
        child: Align(child: Icon(Icons.delete, color: Colors.grey, size: 70,),
